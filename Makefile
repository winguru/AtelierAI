...
help:
	...
	@echo "  make doctor            Show environment and tool availability"
	@echo "  make build-images      Build both Docker images"
	@echo "  make test              Run pytest from repo root"
	@echo "  make test-all          Run the full pytest suite"
	@echo "  make test-bridge       Run A1111 bridge regression test"
	@echo "  make compose-dev-up    Start the Docker dev service"
	@echo "  make compose-dev-shell Open a shell in the Docker dev service"
	@echo "  make compose-dev-run   Run the app inside the Docker dev service"
	@echo "  make compose-runtime-build  Build the runtime Docker image"
	@echo "  make compose-runtime-up     Start the runtime Docker service"
	@echo "  make docker-clean      Stop compose services and remove volumes"
